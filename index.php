...
Ci sono diverse domande con relative risposte. Gestire il “Database”
e la visualizzazione di queste domande e risposte con PHP. -->
...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" href="https://upload.wikimedia.org/wikipedia/commons/0/09/IOS_Google_icon.png">
    ...
    <body>
        <header>
            ...
            <section class='banner'>
                <div class='icon'>
                    <img src="https://lh3.googleusercontent.com/proxy/CmxKDRsrAcMXZgtesM2lnb8EBxKlZn_chx_zJC8vRE_W_pZEijn67Zvgy8_6xT91d6WIAudAKgK_EoUthfoJF5T1MZ_LXDxJzE9w8dpxvAy74WXYfFCBeCs9V7chP0aG1g" alt="google-logo">
                ...
                <div id='nav'>
                    <ul>
                        ...
                        <li>Tecnologie</li>
                        <li id='selezione'>Domande frequenti</li>
                    </ul>
                </div>
            </section>
        </header>
